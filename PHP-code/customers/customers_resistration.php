...
try {
    ...
    $customer = $customersdb->selectAll();
...
<body>
    ...
    <div class="col-sm-8 mx-auto">
        <div class="card mt-3 mb-3">
                ...
                <nav class="navbar" style="background-color: darkred;">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-white" href="./customers_login.php">お客様ログイン</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-white" href="../sponsors/sponsors_login.php">主催者様ログイン</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-white" href="./customers_resistration.php">お客様新規会員登録はこちらから</a>
                            </li>
                            <li class="nav-item">
            ...
            <div class="container">
                <div class="row my-2">
                    <div class="col-sm-3 mt-3 mb-3">お客様新規登録ページ</div>
                ...
                <div class="row my-2">
                    <div class="col-sm-3"></div>
                    <div class="col-sm-6">
                        <form action="./customers_resistration_process.php" method="post">
                            ...
                            <input type="button" value="キャンセル" class="btn btn-warning text-light" onclick="location.href='../top/top_1.php';">
                        </form>
                    </div>
                    <div class="col-sm-3"></div>
                </div>
