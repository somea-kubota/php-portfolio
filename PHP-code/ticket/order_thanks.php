                ...
                <div class="caed-body">
                    <div class="row my-2">
                        ...
                        <div class="col-sm-6 mt-3">
                            ...
                            <br>
                            <div class="message">
                                <p><?= $userinfo['family_name'] . $userinfo['first_name'] ?>様</p>
                                <p>ご注文ありがとうございました。</p>
                                <!-- <p><?= $userinfo['email'] ?>にメールを送りましたのでご確認下さい。</p><br> -->
                                <p>チケットは以下の住所に発送させていただきます。</p><br>
                            ...
                            <br><br><br>
                            <div class="to-top">
                                <input class="btn btn-primary ml-auto d-block" type="button" value="TOPへもどる" onclick="location.href='../top/top_2.php';">
                            </div>
                        </div>
                        <div class="col-sm-3"></div>
                    </div>
