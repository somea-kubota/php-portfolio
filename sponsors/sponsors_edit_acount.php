...
try {
    ...
    // レコードを取得する
    $Sponsor = $Sponsorsdb->getSponsorById($_SESSION['userinfo']['id']);
        ...
        <div class="card mt-3 mb-3">
            ...
            <div class="card-header" style="background-color: darkred;">
                ...
                <nav class="navbar" style="background-color: darkred;">
                    <a class="navbar-brand text-white" href="../top/top_1.php">ちけっと</a>
            ...
            <div class="container">
                <div class="row my-2">
                    <div class="col-sm-3 mt-3 mb-3">主催者様情報修正ページ</div>
                ...
                <div class="row my-2">
                    <div class="col-sm-3"></div>
                    <div class="col-sm-6">
                        <form action="./sponsors_edit_acount_process.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="postal_code" id="postal_code" value="<?= $Sponsor['postal_code'] ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="city_name" id="city_name" value="<?= $Sponsor['city_name'] ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="town_name" id="town_name" value="<?= $Sponsor['town_name'] ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="building_name" id="building_name" value="<?= $Sponsor['building_name'] ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="phone_number" id="phone_number" value="<?= $Sponsor['phone_number'] ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="email" id="email" value="<?= $Sponsor['email'] ?>">
                            ...
                            <div class="my-2 text-right">
                                <button type="submit" value="" class="btn btn-warning" onclick="location.href='./index.php';">修正</button>
                                <button type="button" value="" class="btn btn-primary" onclick="location.href='./index.php';">キャンセル</button>
                            </div>
                        </form>
                    </div>
                </div>
